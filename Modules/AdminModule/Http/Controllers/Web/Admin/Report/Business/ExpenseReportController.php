...
class ExpenseReportController extends Controller
{
    ...
    public function get_business_expense_report(Request $request)
    {
        ...
        return view('adminmodule::admin.report.business.expense', compact('zones', 'categories', 'sub_categories', 'filtered_booking_amounts', 'chart_data', 'total_promotional_cost', 'deterministic', 'query_params'));
    }
