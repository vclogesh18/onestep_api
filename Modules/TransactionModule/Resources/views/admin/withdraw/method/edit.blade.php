...
@push('script')
    <script>
        ...
        jQuery(document).ready(function ($) {
            counter = {{count($withdrawal_method['method_fields'])+1}};
                    ...
                    $('#custom-field-section').append(
                        `<div class="card card-body mb-30" id="field-row--${counter}">
                            <div class="row gy-4 align-items-center">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="" name="is_required[]" id="flexCheckDefault__${counter}" checked>
