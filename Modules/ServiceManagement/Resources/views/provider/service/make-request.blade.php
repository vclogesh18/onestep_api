                        ...
                        <div class="card-body py-xl-5">
                            <div class="row justify-content-center align-items-center gy-5">
                                <div class="col-7 col-lg-5">
                                    ...
                                    <form action="{{route('provider.service.make-request')}}" method="post" class="d--none" id="serviceForm">
                                        @csrf
                                        <div class="mb-30">
                                    ...
                                    <a href="#" class="btn btn--primary show_form-btn collapsed" data-toggle="collapse" data-target="serviceForm">{{translate('Send Request')}}</a>
