...
$pending_booking_count = \Modules\BookingModule\Entities\Booking::ofBookingStatus('pending')->where('zone_id', auth()->user()->provider->zone_id)->whereIn('sub_category_id', $subscribed_sub_category_ids)->count();
